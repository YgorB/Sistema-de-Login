...
const hiddenRegister = document.getElementById('register');
...
function login(){
    ...
    if(loged && isUser){
        alertError.innerHTML = 'logado com sucesso';
        loginEmail = '';
        loginPassword = '';
    }else if( loged && !isUser){
        alertError.innerHTML = 'senha incorreta';
        loginEmail = '';
        loginPassword = '';
    } else{
        alertError.innerHTML = 'usuario não encontrado';
    }
}
...
function hidden(){
    if(hiddenRegister.style.display === 'flex'){
        hiddenRegister.style.display = 'none'
        register.innerHTML = 'Cadastrar'

    }else{
        hiddenRegister.style.display = 'flex'
